...
var Block = function (_Component) {
  ...
  function Block(props) {
    ...
    _this._handleZoomableChange = _this._handleZoomableChange.bind(_this);
  ...
  _createClass(Block, [{
    ...
    key: "_handleZoomableChange",
    value: function _handleZoomableChange(event) {
      event.stopPropagation();
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                "label",
                { className: "zoomableLabel", "for": this.props.container.props.offsetKey + "-zoomable" },
                "Zoomable"
              )
            ),
